...
export const UI_DESIGN_CHANNELS: UiDesignChannelDefinition[] = [
  {
    ...
    endpointPlaceholder: 'https://api.figma.com/v1',
    supportsKey: true,
    needsKey: true,
    keyLabel: 'Figma Token',
    ...
    note: '商用协作设计路线。适合游戏 HUD、菜单、图标规范和设计系统稿，支持通过 API 读取文件与导出切图。',
  },
  {
    id: 'photoshop',
    ...
    requiresCommand: false,
    defaultCommand: '',
    commandPlaceholder: 'Photoshop 可执行文件路径或启动命令',
    credentialUrl: 'https://www.adobe.com/products/photoshop.html',
    defaultExportFormat: 'psd',
    exportFormats: ['psd', 'png', 'svg', 'pdf'],
    note: '商用视觉资产路线。适合游戏 UI 高保真视觉、图标、按钮状态和宣传级界面素材；可记录本机启动命令或工具路径。',
  },
  {
    id: 'pencil',
    label: 'Pencil Project',
    category: 'free-open',
    ...
    requiresCommand: false,
    defaultCommand: '',
    commandPlaceholder: 'Pencil 可执行文件路径或启动命令',
    credentialUrl: 'https://pencil.evolus.vn/',
    defaultExportFormat: 'epgz',
    exportFormats: ['epgz', 'png', 'svg', 'pdf'],
    note: '免费开源原型路线。适合快速画游戏界面线框、流程稿、控件布局和可导出的 UI 说明图。',
  },
  {
    id: 'penpot',
    label: 'Penpot',
    ...
    supportsBaseUrl: true,
    requiresBaseUrl: false,
    defaultBaseUrl: 'https://design.penpot.app',
    endpointPlaceholder: 'https://design.penpot.app 或自托管地址',
    supportsKey: true,
    needsKey: false,
    keyLabel: 'Penpot Token',
    keyPlaceholder: '可选，粘贴自托管或 API Token',
    supportsCommand: false,
    requiresCommand: false,
    defaultCommand: '',
    commandPlaceholder: '',
    ...
    note: '开源协作设计路线。适合团队化游戏 UI 原型、组件库和设计系统，也可接自托管 Penpot 实例。',
  },
  {
    id: 'gimp-inkscape',
    label: 'GIMP / Inkscape',
    ...
    requiresCommand: false,
    defaultCommand: '',
    commandPlaceholder: 'gimp、inkscape 或你的批处理脚本路径',
